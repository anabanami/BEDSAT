...
% can you include a verrrrrry brief overview of this model on page 9 and describe how it relates to the momentum equations / inverse methods you describe there? but also say that it hasn't been integrated within an ice sheet model and that is a big gap because [describe why that's a problem or how budd equations could provide a solution to the problem]
