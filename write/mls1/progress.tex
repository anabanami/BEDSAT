...
The next stage in this investigations is developing a variety of synthetic bedrock topographies to understand the relationship between basal geometry, ice rheology, and overall flow response to more complex bed conditions. This bedrock database will be used in to create a large data set of bed features to surface (response) features that can be used to train a image recognition (machine learning) model.% This model needs to be able to understand transferfunction subtleties
\newpage
...
\end{figure}
% \begin{figure}[H]
%     \includegraphics[scale=0.45]{IsmipF_S2_convergence_summary_zoom.png}
%     \caption{Velocity convergence summary for S2 using experiment F in ISMIP HOM. ... }
...
\end{figure}
% \begin{figure}[H]
%     \includegraphics[scale=0.45]{IsmipF_S4_convergence_summary_zoom.png}
%     \caption{Velocity convergence summary for S4 using experiment F in ISMIP HOM. ... }
...
% %%% S2
% \begin{figure}[H]
%     \includegraphics[scale=0.45]{S2_F_signals.pdf}
%     \caption{The isolated bedrock and ice surface signals}
%     \label{fig:phase_analysis_Signals}
% \end{figure}

% \begin{figure}[H]
%     \includegraphics[scale=0.45]{S2_F_correlation_t_0036.png}
%     \caption{The cross-correlation function and the detected lag of maximum correlation.}
%     \label{fig:phase_analysis_Cross_Correlation}
% \end{figure}

% \begin{figure}[H]
%     \includegraphics[scale=0.45]{S2_F_phase_evolution_summary.png}
%     \caption{The evolution of the phase shift and spatial lag over the entire simulation.}
%     \label{fig:phase_analysis_Evolution_Plots}
% \end{figure}
% %%% S3
% \begin{figure}[H]
%     \includegraphics[scale=0.45]{S3_F_signals.pdf}
%     \caption{the isolated bedrock and ice surface signals}
%     \label{fig:phase_analysis_Signals}
% \end{figure}

% \begin{figure}[H]
%     \includegraphics[scale=0.45]{S3_F_correlation_t_0036.png}
%     \caption{The cross-correlation function and the detected lag of maximum correlation.}
%     \label{fig:phase_analysis_Cross_Correlation}
% \end{figure}

% \begin{figure}[H]
%     \includegraphics[scale=0.45]{S3_F_phase_evolution_summary.png}
%     \caption{The evolution of the phase shift and spatial lag over the entire simulation.}
%     \label{fig:phase_analysis_Evolution_Plots}
% \end{figure}
% %%% S4
% \begin{figure}[H]
%     \includegraphics[scale=0.45]{S4_F_signals.pdf}
%     \caption{The isolated bedrock and ice surface signals}
%     \label{fig:phase_analysis_Signals}
% \end{figure}

% \begin{figure}[H]
%     \includegraphics[scale=0.45]{S4_F_correlation_t_0036.png}
%     \caption{The cross-correlation function and the detected lag of maximum correlation.}
%     \label{fig:phase_analysis_Cross_Correlation}
% \end{figure}

% \begin{figure}[H]
%     \includegraphics[scale=0.45]{S4_F_phase_evolution_summary.png}
%     \caption{The evolution of the phase shift and spatial lag over the entire simulation.}
%     \label{fig:phase_analysis_Evolution_Plots}
% \end{figure}
% % ======================================================
