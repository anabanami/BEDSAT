...
\item{Targeted Scientific Plotting} Additional scripts (\texttt{elevations\_velocities\_combined}) are used to create specific scientific plots..
\end{enumerate}
...
\begin{figure}[H]
    \includegraphics[scale=0.45]{IsmipF_S1_convergence_summary.png}
    \caption{Velocity convergence summary for S1 using experiment F in ISMIP HOM. ...}
    \label{fig:grid_conv_S1}
\end{figure}
\begin{figure}[H]
    \includegraphics[scale=0.45]{IsmipF_S2_convergence_summary.png}
...
% \end{figure}
\begin{figure}[H]
    \includegraphics[scale=0.45]{IsmipF_S3_convergence_summary.png}
    \caption{Velocity convergence summary for S3 using experiment F in ISMIP HOM. ... }
    \label{fig:grid_conv_S3}
\end{figure}
\begin{figure}[H]
    \includegraphics[scale=0.45]{IsmipF_S4_convergence_summary.png}
    \caption{Velocity convergence summary for S4 using experiment F in ISMIP HOM. ... }
...
%%%% S1
\begin{figure}[H]
    \includegraphics[scale=0.49]{S1_F_signals.pdf}
...
\begin{figure}[H]
    \includegraphics[scale=0.45]{S1_F_correlation_t_0036.png}
...
\begin{figure}[H]
    \includegraphics[scale=0.39]{S1_F_phase_evolution_summary.png}
